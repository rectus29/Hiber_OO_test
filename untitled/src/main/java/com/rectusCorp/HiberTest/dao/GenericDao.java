package com.rectusCorp.HiberTest.dao;/**
 * User: rectus_29
 * Date: 20 mai 2009
 */

import com.rectusCorp.HiberTest.entities.sys.GenericEntity;
import com.rectusCorp.HiberTest.enums.SortOrder;
...
public interface GenericDao<T extends GenericEntity, PK extends Serializable> {
    ...
    List<T> getAllWithPagination(int start, int count, String sortPropertyName, boolean sortAscendingOrder,
			String filterPropertyName, Object filter);
    ...
    public List<T> getAllByPropertyOrdered(String property, Object value, String sortPropertyName,
			boolean sortAscendingOrder);

    public List<T> getAllByProperties(HashMap<String, Object> hm);

    public List<T> getAllByPropertiesOrdered(Map<String, Object> hm, String sortPropertyName,
			boolean sortAscendingOrder);
